    ...
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="../../index.php"><img src="../../assets/images/logo2.svg"
                        alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="../../index.php"><img
                        src="../../assets/images/logo-mini2.svg" alt="logo" /></a>
            </div>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.html" style="padding-bottom: 0%;">
                    ...
                    <li class="nav-item sidebar-actions">
                        <span class="nav-link">
                            <div class="border-bottom">
                                <h6 class="font-weight-normal mb-3">My Quizs</h6>
                            </div>

                            <a href="pages/forms/CreateQuiz.php" style="text-decoration: none;">
                                <button class="btn btn-block btn-lg btn-gradient-success mt-4"
                                    style="display: block;">Create a
                                    quiz </button></a>
                            <button class="btn btn-block btn-lg btn-gradient-secondary mt-4"
                                style="display: block;padding-right: 65px;">
                                Edit a quiz
                            </button>
                            <button class="btn btn-block btn-lg btn-gradient-danger mt-4" style="display: block;">Delete
                                a
                                quiz</button>
                            <div class="mt-4">
                                <div class="border-bottom">
                                ...
                                <ul class="gradient-bullet-list mt-4">
                                    <a href="#" style="text-decoration: none;">
                                        <button class="btn btn-block btn-lg btn-gradient-info mt-4"
                                            style="display: block;">Quiz
                                            scores </button></a>
                                </ul>
                            </div>
                        </span>
          ...
          <span class="nav-link">
            ...
            <button class="btn btn-block btn-lg btn-gradient-success mt-4" style="display: block;">Create a
              quiz</button>
            <button class="btn btn-block btn-lg btn-gradient-secondary mt-4"
              style="display: block;padding-right: 65px;">
              Edit a quiz
            </button>
            <button class="btn btn-block btn-lg btn-gradient-danger mt-4" style="display: block;">Delete a
              quiz</button>
            <div class="mt-4">
              <div class="border-bottom">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="POST" action="SaveNewQuiz.php">
                                        ...
                                        <button type="submit" name="submit" id="submit"
                                            class="btn btn-gradient-success btn-rounded btn-fw">Submit</button>
                                        <button class="btn btn-gradient-light btn-rounded btn-fw">Cancel</button>
                                    </form>
                                </div>
                            </div>
                        </div>
