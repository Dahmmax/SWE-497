...
if (isset($_POST['check-email'])) {
    ...
    if (mysqli_num_rows($run_sql) > 0) {
        ...
        if ($run_query) {
            ...
            //$sender = "From: TurkiKFMC@hotmail.com ";
                          ...
                          <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                            ...
                            <tr>
                              <td align="center" style="padding:0;Margin:0;font-size:0px"><img
                                  src="https://zhizlf.stripocdn.email/content/guids/CABINET_de2cb1f0b4bc6cba5603fc3f2df4d29f/images/picturelogo.png"
                                  alt="Logo"
                                  style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;font-size:12px"
                                  width="45" title="Logo" class="adapt-img"></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                            ...
                            <tr>
                              <td align="center"
                                style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;font-size:0px"><img
                                  src="https://zhizlf.stripocdn.email/content/guids/CABINET_91d375bbb7ce4a7f7b848a611a0368a7/images/69901618385469411.png"
                                  alt
                            ...
                            <tr>
                              <td align="left" style="padding:0;Margin:0;padding-top:10px">
                                <p
                                  ...
                                  <strong>Your rest code is ' . $code . ' </strong>,please enter this code to rest your password,<br> after you
                                  Enterd the OTP Code, you"ll be asked to complete the following steps:</p>
                                <ol>
                                  <li
                            ...
                            <tr>
                              <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-top:10px">
                                <h3
                                  ...
                                  This code is valid for one use only.</h3>
                              </td>
                            </tr>
                            <tr>
                              <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                <p
                                  ...
                                  contact our customer service department.</p>
                              </td>
                            </tr>
                          </table>
                        </td>
                            ...
                            <tr>
                              <td align="center" style="padding:0;Margin:0;padding-bottom:35px">
                                <p
                                  ...
                                  ScheduleUp&nbsp;© 2022, Inc. All Rights Reserved.<br></p>
                              </td>
                            </tr>
                            <tr>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" class="es-menu"
                                  ...
                                  <tr class="links">
                                    <td align="center" valign="top" width="50%"
                                      ...
                                      <a target="_blank" href="https://scheup.com"
                                    ...
                                    <td align="center" valign="top" width="50%"
                                      ...
                                      <a target="_blank" href=""
                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, "helvetica neue", helvetica, sans-serif;color:#333333;font-size:12px">support@Scheup.com</a>
                                    </td>
                                  </tr>
                                </table>
                              </td>
