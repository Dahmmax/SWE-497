...
<body onload="table();">
    ...
    width: max-content;">
                            ...
                            <button type="button" id="startQuiz"  class="btn btn-gradient-success btn-fw">Go to the quiz room</button>
                        </div>
...
<script>
    ...
    $("#startQuiz").click(function() {
        window.location.href = "../Quiz-App/index.html?Qid="+Qid+"&QuizCode="+Qcode;
    });
</script>
<!-- container-scroller -->
<!-- plugins:js -->
