    ...
    <div class="container-fluid page-body-wrapper">
        <div class="main-panel">
            <div class="content-wrapper" style="width: 122%">
                <h1 class="display-4" style="color:#9a55ff;position: inherit;margin: -15px 339px;">Question</h1>
                <!-- /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                <div class="row">
                    ...
                    padding: 20px 0px;">
                        <div class="card">
                            <div class="card-body">
                            <canvas id="barChart" style="height: 191px; display: block; width: 383px;" width="383" height="191" class="chartjs-render-monitor"></canvas>
                                   <!-- </form> -->
                            </div>
                        </div>
                    </div>
